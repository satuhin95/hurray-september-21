...
function ws_blast(q, j, m) {
    ...
    function n(r) {
        ...
        for (var u = 0; u < d * p; u++) {
            ...
            e([(b[u] = document.createElement("div")), (l[u] = document.createElement("div"))])
    ...
    function o(t, u, s, r, w, z) {
        ...
        e(t).each(function (F) {
            ...
            e(this)
                .find("img")
                .css({ left: -((v * E) / d) + u.marginLeft, top: -((x * C) / p) + u.marginTop, width: u.width, height: u.height });
    ...
    this.go = function (s, u) {
        var v = e(j[u]),
            r = { width: v.width(), height: v.height(), marginTop: parseFloat(v.css("marginTop")), marginLeft: parseFloat(v.css("marginLeft")) };
        if (!l.length) {
            n(r);
        }
